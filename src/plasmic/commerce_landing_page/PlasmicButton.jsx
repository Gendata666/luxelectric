...
import sty from "./PlasmicButton.module.css"; // plasmic-import: vukcc0SocRdk/css
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__eErIa, {
          [sty.freeBoxcolor_neutral__eErIaZ2Ef]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__eErIakdjbO]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__eErIa6D7Vh]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__eErIaV06XW]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__eErIaB7EXw]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__eErIahC2Ku]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__eErIaReZAy]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__eErIaReZAySiM5Z]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__ue7Sh, {
            [sty.freeBoxcolor_neutral__ue7ShZ2Ef]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__ue7ShZ2EfIC1O]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__ue7ShUu6G9]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__ue7Sh6D7Vh]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__ue7ShB7EXw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__ue7ShhC2Ku]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__ue7ShReZAy]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__pcsJg)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__pM0Mi, {
            [sty.freeBoxiconEnd__pM0MicbC0I]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__pM0Mi6D7Vh]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__pM0MiB7EXw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__pM0MihC2Ku]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__whElT)}
                role={"img"}
              />
            ),
